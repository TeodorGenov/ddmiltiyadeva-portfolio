...
var aboutMeNav = document.getElementById("about-me-nav");
aboutMeNav.addEventListener("click", function () {
  document.getElementById("about-me").scrollIntoView({
    behavior: "smooth"
  });
});
var photographyNav = document.getElementById("photography-nav");
photographyNav.addEventListener("click", function () {
...
var brandNav = document.getElementById("brand-nav");
...
var graphicDesignButton = document.getElementById("graphic-design-nav");
var clicked = false;
...
graphicDesignButton.addEventListener("click", function () {
  if (!clicked) {
    ...
    (0, _animeEs.default)({
      targets: ".graphic-design .el",
      translateY: _animeEs.default.stagger(40, {
        start: 40
      }),
      opacity: 1,
      delay: _animeEs.default.stagger(100, {
...
setTimeout(function () {
  var logEl = document.getElementsByTagName("span");
...
var mouseIn = false; // PHOTOGRAPHY SCROLL SLIDE

var horizontalDiv = document.querySelector(".horizontal-scroll");
var photographyTitleDiv = document.querySelector(".photography-title");

horizontalDiv.onwheel = function (event) {
  var scrollAmount = 0;
  event.preventDefault(); // horizontalDiv.scrollLeft += event.deltaY;
  ...
  var deltaWidth = horizontalDiv.scrollWidth - horizontalDiv.scrollLeft;
}; // LOGO SCROLL SLIDE


var horizontalDivLogo = document.querySelector(".horizontal-scroll-logo");
var logoTitleDiv = document.querySelector(".logo-title");

horizontalDivLogo.onwheel = function (event) {
  var scrollAmount = 0;
  event.preventDefault(); // horizontalDiv.scrollLeft += event.deltaY;
  ...
  var deltaWidth = horizontalDivLogo.scrollWidth - horizontalDivLogo.scrollLeft;
}; // BRAND SCROLL SLIDE


var horizontalDivBrand = document.querySelector(".horizontal-scroll-brand");
var brandTitleDiv = document.querySelector(".brand-title");

horizontalDivBrand.onwheel = function (event) {
  var scrollAmount = 0;
  event.preventDefault(); // horizontalDiv.scrollLeft += event.deltaY;
  ...
  var deltaWidth = horizontalDivBrand.scrollWidth - horizontalDivBrand.scrollLeft;
}; // ILLUSTRATIONS SCROLL SLIDE


var horizontalDivIllu = document.querySelector(".horizontal-scroll-illu");
var illustrationTitleDiv = document.querySelector(".illustrations-title");

horizontalDivIllu.onwheel = function (event) {
  var scrollAmount = 0;
  event.preventDefault();
  console.log(horizontalDivIllu.scrollLeft); // horizontalDiv.scrollLeft += event.deltaY;
  ...
  var deltaWidth = horizontalDivIllu.scrollWidth - horizontalDivIllu.scrollLeft;
};
...
body.addEventListener("scroll", function () {
  ...
  if (photographyTitleDiv.getBoundingClientRect().y < -700 || photographyTitleDiv.getBoundingClientRect().y > 700) {
    photographyTitleDiv.classList.remove("photography-slide");
  } else if (illustrationTitleDiv.getBoundingClientRect().y < -700 || illustrationTitleDiv.getBoundingClientRect().y > 450) {
    illustrationTitleDiv.classList.remove("illustrations-slide");
  }

  photographyTitleDiv.onwheel = function (event) {
    if (event.deltaY > 0) {
  ...
  illustrationTitleDiv.onwheel = function (event) {
...
projectDMClick.onclick = function () {
  modalProjectDM.style.display = "block";
};

project5in1Click.onclick = function () {
  modalProject5in1.style.display = "block";
};

projectFondClick.onclick = function () {
  modalProjectFond.style.display = "block";
};

projectBuroClick.onclick = function () {
...
var closeBuroCoModal = document.getElementsByClassName("close")[3]; // var closeBoschModal = document.getElementsByClassName("close")[4];
...
closeDMModal.onclick = function () {
  modalProjectDM.style.display = "none";
};

close5in1Modal.onclick = function () {
  modalProject5in1.style.display = "none";
};

closeFondModal.onclick = function () {
  modalProjectFond.style.display = "none";
};

closeBuroCoModal.onclick = function () {
  modalProjectBuro.style.display = "none";
}; // closeBoschModal.onclick = (event) => {
// 	console.log(event.target);
// 	modalProjectDM.style.display = "none";
// };
},{"animejs/lib/anime.es.js":"../node_modules/animejs/lib/anime.es.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
